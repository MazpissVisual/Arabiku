...
export default function Home() {
  return (
    <div className="h-screen w-full flex flex-col items-center justify-center p-4 relative bg-[url('/bg-main.jpg')] bg-cover bg-center bg-no-repeat overflow-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center w-full max-w-sm gap-6 md:gap-10">
        {/* Header / Logo Area */}
        <div className="flex flex-col items-center mb-2 text-center">
            <h1 className="text-5xl sm:text-6xl md:text-8xl font-black text-[#FFF176] drop-shadow-[0_4px_0_#F57F17] md:drop-shadow-[0_6px_0_#F57F17] tracking-tighter mb-2 md:mb-4 stroke-text animate-pulse-slow">
                Arabiku
            </h1>
            <div className="bg-[#FFF9C4]/90 px-6 py-1.5 md:px-8 md:py-2.5 rounded-[2rem] border-2 md:border-4 border-[#FBC02D] shadow-xl transform -rotate-1">
                <p className="text-base md:text-xl font-black text-[#E65100] uppercase tracking-widest">Belajar Bahasa Arab</p>
            </div>
        </div>

        {/* Menu Buttons Stack */}
        <div className="flex flex-col w-full gap-4 md:gap-6 px-2">
            ...
            <Link href="/materials" className="w-full btn-float group">
                <button className="w-full relative transform transition-all duration-200 group-hover:scale-105 active:scale-95 text-left">
                    ...
                    <div className="relative bg-gradient-to-b from-[#FFFDE7] to-[#FFF9C4] p-3.5 md:p-5 rounded-2xl border-2 md:border-4 border-white flex items-center justify-between shadow-inner">
                        ...
                        <PlayCircle size={28} className="text-[#FBC02D] md:size-8 group-hover:translate-x-1 transition-transform" />
        ...
        <div className="mt-2 md:mt-4">
            <Link href="/admin/login">
                <button className="bg-white/10 hover:bg-white/20 backdrop-blur-md px-5 py-1.5 md:px-6 md:py-2 rounded-full border border-white/30 text-white font-bold text-xs md:text-sm transition-all shadow-lg active:scale-95">
                   Login Guru / Admin 🔐
                </button>
            </Link>
        </div>
