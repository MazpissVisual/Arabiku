...
export default function Home() {
  return (
    <div className="h-screen w-full flex flex-col items-center justify-center p-4 relative bg-[url('/bg-main.jpg')] bg-cover bg-center bg-no-repeat overflow-hidden">
      {/* Overlay for better text readability */}
      <div className="absolute inset-0 bg-black/10 z-0 fixed"></div>

      <main className="relative z-10 flex flex-col items-center justify-center w-full max-w-sm gap-3 md:gap-10 scale-[0.85] sm:scale-100 origin-center">
        {/* Header / Logo Area */}
        <div className="flex flex-col items-center mb-1 md:mb-4 text-center">
            ...
            <div className="bg-[#FFF9C4]/90 px-5 py-1 md:px-8 md:py-2.5 rounded-[2rem] border-2 md:border-4 border-[#FBC02D] shadow-xl transform -rotate-1">
                <p className="text-xs sm:text-base md:text-xl font-black text-[#E65100] uppercase tracking-widest">Belajar Bahasa Arab</p>
            </div>
        </div>

        {/* Menu Buttons Stack */}
        <div className="flex flex-col w-full gap-3 md:gap-6 px-2">
                ...
                <button className="w-full relative transform transition-all duration-200 group-hover:scale-105 active:scale-95 text-left">
                    ...
                    <div className="relative bg-gradient-to-b from-[#FFFDE7] to-[#FFF9C4] p-3 md:p-5 rounded-2xl border-2 md:border-4 border-white flex items-center justify-between shadow-inner">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-[#E65100] font-black text-lg md:text-2xl uppercase tracking-tighter">Mulai Belajar</span>
                        </div>
                        <PlayCircle size={24} className="text-[#FBC02D] md:size-8 group-hover:translate-x-1 transition-transform" />
                        
                        {/* Shine Effect */}
                        <div className="absolute top-2 left-4 w-10 h-4 md:w-12 md:h-6 bg-white/40 rounded-full rotate-[-20deg] blur-[2px]"></div>
                    </div>
                </button>
            </Link>
                ...
                <button className="w-full relative transform transition-all duration-200 group-hover:scale-105 active:scale-95 text-left">
                    ...
                    <div className="relative bg-gradient-to-b from-[#FFFDE7] to-[#FFF9C4] p-3 md:p-5 rounded-2xl border-2 md:border-4 border-white flex items-center justify-between shadow-inner">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-[#E65100] font-black text-lg md:text-2xl uppercase tracking-tighter">Latihan Quiz</span>
                        </div>
                        <PlayCircle size={24} className="text-[#FBC02D] md:size-8 group-hover:translate-x-1 transition-transform" />
            ...
            <div className="w-full relative opacity-80 cursor-not-allowed group btn-float-delay-2 grayscale-[0.5]">
                ...
                <div className="relative bg-white/90 p-3 md:p-5 rounded-2xl border-2 md:border-4 border-gray-100 flex items-center justify-between shadow-inner">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-gray-400 font-black text-lg md:text-2xl uppercase tracking-tighter">Tutorial</span>
                    </div>
