        ...
        <div className="flex flex-col w-full gap-2 md:gap-6 px-1">
            ...
            <Link href="/materials" className="w-full btn-float group">
                <button className="w-full relative transform transition-all duration-200 group-hover:scale-105 active:scale-95 text-left">
                    ...
                    <div className="relative bg-gradient-to-b from-[#FFFDE7] to-[#FFF9C4] p-2.5 md:p-5 rounded-2xl border-2 md:border-4 border-white flex items-center justify-between shadow-inner">
                        <div className="flex items-center gap-3">
                            <div className="w-8 h-8 md:w-12 md:h-12 bg-orange-500 rounded-xl flex items-center justify-center text-white shadow-md border-2 border-white/50">
                                <GraduationCap size={18} className="md:size-7" strokeWidth={2.5} />
                            </div>
                            <span className="text-[#E65100] font-black text-base md:text-2xl uppercase tracking-tighter">Mulai Belajar</span>
                        </div>
                        <PlayCircle size={22} className="text-[#FBC02D] md:size-8 group-hover:translate-x-1 transition-transform" />
                        
                        {/* Shine Effect */}
                        <div className="absolute top-1 left-4 w-10 h-3 md:w-12 md:h-6 bg-white/40 rounded-full rotate-[-20deg] blur-[2px]"></div>
                    </div>
                </button>
            </Link>
            ...
            <Link href="/quizzes" className="w-full btn-float-delay-1 group">
                <button className="w-full relative transform transition-all duration-200 group-hover:scale-105 active:scale-95 text-left">
                    ...
                    <div className="relative bg-gradient-to-b from-[#FFFDE7] to-[#FFF9C4] p-2.5 md:p-5 rounded-2xl border-2 md:border-4 border-white flex items-center justify-between shadow-inner">
                        <div className="flex items-center gap-3">
                            <div className="w-8 h-8 md:w-12 md:h-12 bg-blue-500 rounded-xl flex items-center justify-center text-white shadow-md border-2 border-white/50">
                                <Gamepad2 size={18} className="md:size-7" strokeWidth={2.5} />
                            </div>
                            <span className="text-[#E65100] font-black text-base md:text-2xl uppercase tracking-tighter">Latihan Quiz</span>
                        </div>
                        <PlayCircle size={22} className="text-[#FBC02D] md:size-8 group-hover:translate-x-1 transition-transform" />
            ...
            <div className="w-full relative opacity-80 cursor-not-allowed group btn-float-delay-2 grayscale-[0.5]">
                ...
                <div className="relative bg-white/90 p-2.5 md:p-5 rounded-2xl border-2 md:border-4 border-gray-100 flex items-center justify-between shadow-inner">
                    <div className="flex items-center gap-3">
                        <div className="w-8 h-8 md:w-12 md:h-12 bg-gray-200 rounded-xl flex items-center justify-center text-gray-400 border-2 border-white/50">
                            <Lock size={16} className="md:size-6" />
                        </div>
                        <span className="text-gray-400 font-black text-base md:text-2xl uppercase tracking-tighter">Tutorial</span>
                    </div>
