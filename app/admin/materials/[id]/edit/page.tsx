  ...
  const fetchInitialData = async () => {
    try {
        ...
        if (matData) {
            ...
            setCategoryId(matData.category_id.toString())
            setArabicText(matData.arabic_text)
            setTranslation(matData.translation)
            setReading(matData.reading || '')
            setExampleSentence(matData.example_sentence || '')
            setExampleReading(matData.example_reading || '')
            setExampleMeaning(matData.example_meaning || '')
            setExampleSentence2(matData.example_sentence_2 || '')
            setExampleReading2(matData.example_reading_2 || '')
            setExampleMeaning2(matData.example_meaning_2 || '')
            setImageUrl(matData.image_url || '')
        }
    } catch (error: any) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-800">Edit Materi</h1>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4 border-t border-gray-100 flex justify-end">
                ...
                >
                    {submitting ? <Loader2 className="animate-spin" size={20} /> : <><Save size={18} /> Simpan Perubahan</>}
                </button>
            </div>
        </form>
      </div>
